 ...
 */
@Controller
public class FRegistContactArticleController {
	...
	private Logger logger = org.slf4j.LoggerFactory.getLogger(FRegistContactArticleController.class);
	...
	public ModelAndView init(@Valid  FContactArticleForm fContactArticleForm, HttpSession session) {
		...
		mav.setViewName("/front/fRegistContactArticle");
