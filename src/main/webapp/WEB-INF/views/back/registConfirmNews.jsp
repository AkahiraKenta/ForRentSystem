...
<html lang="ja">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ニュース情報登録確認</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	<div class="col-lg-12">
            		<form:form method="post" action="${pageContext.request.contextPath}/back/callRegistCompleteNews" modelAttribute="newsForm">
	                    <div class="panel panel-default">
		                    ...
		                    <div class="panel-body">
                            	...
                            	<div class="btnBox">
                            		<input id="registCompleteNews" name="back" type="submit" class="btn btn-warning btn-lg" value="戻る" />
									<input id="registCompleteNews" type="submit" class="btn btn-primary btn-lg" value="登録完了" />
								</div>
							</div>
						</div>
					</form:form>
