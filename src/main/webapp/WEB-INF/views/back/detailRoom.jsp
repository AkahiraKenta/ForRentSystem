...
<html lang="ja">
	<head>
		...
		<script src="${pageContext.request.contextPath}/resources/js/part/detailRoom.js"></script>
		<title>部屋詳細画面</title>
	</head>
    <body>
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">部屋情報詳細</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
				<form:form method="post" action="${pageContext.request.contextPath}/back/callEditRoom" modelAttribute="detailRoomForm">
	                <div class="col-lg-8">
	                                ...
	                                <table class="table table-striped table-bordered table-hover editTable" id="edit-mainDataList">
	                                    <tbody>
	                                    	...
	                                    	<tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.buildingCode}" />
											...
											<tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.buildingName}" />
	                    ...
	                    <div class="panel panel-default">
	                        ...
	                        <div class="panel-body">
	                                ...
	                                <table class="table table-striped table-bordered table-hover editTable" id="edit-mainDataList">
	                                    <tbody>
	                                    	<tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.roomCode}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.roomNumber}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.numberOfStoreysName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.recruitmentStatusName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.floorPlanName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.space}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.rent}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.commonServiceFeeClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.commonServiceFee}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.administrativeCostClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.administrativeCost}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.securityDepositClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.securityDeposit}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.keyMoneyClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.keyMoney}" />
	                                         ...
	                                         <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.premiumClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.premium}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.renewalFeeClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.renewalFee}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.securityMoneyClassName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.securityMoney}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.amortization}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.guarantyCompanyName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.publicationName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.contractFormName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.deliveryMethodName}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.deliveryTime}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.contractPeriod}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
                                         			<form:textarea  class="form-control" path="importantPoints" rows="10"
	                                            		value="<c:out value=${detailRoomForm.importantPoints} />" readOnly="true" />
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            <th class="item_font_size">
	                                            ...
	                                            <td>
	                                            	<c:out value="${detailRoomForm.roomPrTitle}" />
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<form:textarea  class="form-control" path="roomPrDetail" rows="10"
	                                            		value="<c:out value=${detailRoomForm.roomPrDetail} />" readOnly="true" />
	                                            </td>
	                                        </tr>
	                                   </tbody>
	                               </table>
	                            ...
	                            <div class="btnBox">
	                            	<c:if test="${buildingContactId == 0}">
										<a href="${pageContext.request.contextPath}/back/backDetailRoom?buildingId=${buildingId}" class="btn btn-warning btn-lg">戻る</a>
									</c:if>
									<c:if test="${buildingContactId != 0}">
										<a href="${pageContext.request.contextPath}/back/backDetailBuildingContact?buildingContactId=${buildingContactId}" class="btn btn-warning btn-lg">戻る</a>
									</c:if>
									<c:if test="${detailRoomForm.transactionFlag == 1}">
										<input id="detailRoom" type="submit" class="btn btn-primary btn-lg" value="部屋編集" />
									</c:if>
									<c:if test="${detailRoomForm.transactionFlag == 2}">
										<a id="deleteRoom" href="#" class="btn btn-danger btn-lg">削除</a>
									</c:if>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="edit-mainDataList">
                                    <tbody>
                           				<tr>
											<th>
												<form id="imageRoomDeleteForm" method="post" action="${pageContext.request.contextPath}/back/deleteRoomImageFile">
                                                		...
                                                		<c:forEach var="roomImage" items="${roomImageList}" varStatus="status">
                                                			<div id="imageDiv_${roomImage.imageId}">
	                                                			<c:out value="${roomImage.imageCaption}"></c:out>
															 	<img id="imageView_${roomImage.imageId}" alt="" class="imgView img-responsive" src="${filePath}${roomImage.buildingId}/${roomImage.roomId}/${roomImage.fileName}" style="width:130px; height:100px;">
																<button id="imageDelete_${roomImage.buildingId}_${roomImage.roomId}_${roomImage.imageId}" name="imgRoomInput" type="button" style="margin-bottom:15px" class="btn btn-danger btn-sm">削除</button>
															</div>
														</c:forEach>
                                                	</div>
	                                            </form>
