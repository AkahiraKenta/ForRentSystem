...
<html lang="ja">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ニュース情報編集</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	<div class="col-lg-12">
            		<form:form method="post" action="${pageContext.request.contextPath}/back/callEditConfirmNews" modelAttribute="newsForm">
	                    <div class="panel panel-default">
		                    ...
		                    <div class="panel-body">
                            	...
                            	<div class="btnBox">
									<a href="${pageContext.request.contextPath}/back/backEditNews" class="btn btn-warning btn-lg">戻る</a>
									<input id="editConfirmNews" type="submit" class="btn btn-primary btn-lg" value="編集確認" />
								</div>
							</div>
						</div>
					</form:form>
