...
<html>
	<head>
		...
		<title>一般のお問合せ・完了｜KURASHI｜不動産サイト</title>
	</head>
	<body>
		<%-- ヘッダー --%>
		...
		<div id="contents">
			...
			<div id="contents_box">
				...
				<%-- 一般のお問合せ --%>
				<section>
					<h2 class="midashi_mail_gr">一般のお問合せ・完了</h2>
				 	<p class="contact_thanks_p">お問合せありがとうございます。</p>
					<p class="contact_thanks_p margin_b70">後ほど、担当者よりご連絡をさせていただきます。</p>
					<%--"確認画面へ"ボタン --%>
					<p class="btn_green"><a id="backRegistContactArticle" href="./frontTop">トップページへ</a></p>
				</section>
			</div>
			<%-- /左コンテンツ --%>
